        ...
        <div className="flex flex-col md:flex-row md:space-x-4 mx-auto w-full md:w-4/5 lg:w-3/4">
          ...
          <div className="w-full md:w-full lg:w-2/3 p-4 md:px-0 sm:px-0 px-0">
            ...
            {inspirationPosts.slice(0, 4).map((post, index) => (
              ...
              >
                <div className="md:w-1/3 lg:hidden xl:block block">
                  <Image
                    src={post.images}
                    alt={post.alt}
                    width={500}
                ...
                <div className="md:w-2/3 sm:px-4 px-0 flex flex-col justify-betwee lg:w-full">
                  <p className="w-1/3 md:w-1/3 md:mb-2 lg:w-1/4 lg:mb-2 xl:w-1/5 xl:mb-2 sm:mt-2 mt-2 md:mt-0 lg:mt-0 mb-2 text-center text-xs md:text-xs lg:text-sm text-white px-2 py-1 border-2 border-sky-500 hover:bg-sky-500 rounded-md">
          ...
          {/* right side */}
          <div className="w-full md:w-1/3 mt-4 md:mt-0 py-4 md:hidden lg:block xl:block">
            {/* latest posts */}
            <div className="">
              ...
              {Posts.sort((a, b) => new Date(b.date) - new Date(a.date))
                ...
                .map((post, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center text-gray-500 mt-2 text-sm md:text-xs lg:text-xs">
                      <div className="flex space-x-4 items-center">
                        <p className=" text-white hover:text-sky-500">
                          <Link href={`/Author/JohnDoe`}>{post.author}</Link>
                        </p>
